...
5. **3-Tier 스케줄링**: 모니터링(10분) / 수정(1회/일, 01:30 단일) / 배포(30분) 분리
   - 수정 배치는 01:30 단일 운영 — 점심/오후 슬롯은 개발자 작업과 충돌 위험으로 제거 (2026-05-01~)
   - 23:30 QA Inspector(hopenvision-only) / 04:30 medium-digest / 06~09시 deploy 창구와 모두 안전 버퍼 확보 (max_duration 90분으로 03:00 종료 보장)
